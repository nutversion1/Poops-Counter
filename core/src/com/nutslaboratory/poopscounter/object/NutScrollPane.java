 ...
 * @author mzechner
 * @author Nathan Sweet */
public class NutScrollPane extends WidgetGroup {
    public com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style;
    public Actor widget;
    ...
    public final Rectangle widgetAreaBounds = new Rectangle();
    ...
    public float visualAmountX, visualAmountY;
    public float maxX, maxY;
    public boolean touchScrollH, touchScrollV;
    public final Vector2 lastPoint = new Vector2();
    public float areaWidth, areaHeight;
    public boolean fadeScrollBars = true, smoothScrolling = true;
    public float fadeAlpha, fadeAlphaSeconds = 1, fadeDelay, fadeDelaySeconds = 1;
    ...
    public float overscrollDistance = 50, overscrollSpeedMin = 30, overscrollSpeedMax = 200;
    ...
    public NutScrollPane (Actor widget) {
        this(widget, new com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle());
    }

    /** @param widget May be null. */
    public NutScrollPane (Actor widget, Skin skin) {
        this(widget, skin.get(com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle.class));
    }

    /** @param widget May be null. */
    public NutScrollPane (Actor widget, Skin skin, String styleName) {
        this(widget, skin.get(styleName, com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle.class));
    }

    /** @param widget May be null. */
    public NutScrollPane (Actor widget, com.badlogic.gdx.scenes.scene2d.ui.ScrollPane.ScrollPaneStyle style) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
                ...
                getStage().setScrollFocus(NutScrollPane.this);
    ...
    public void layout () {
        ...
        if (bg != null) {
            bgLeftWidth = bg.getLeftWidth() + 0;//nutedit
            bgRightWidth = bg.getRightWidth();
            bgTopHeight = bg.getTopHeight() + 14;//nutedit
            bgBottomHeight = bg.getBottomHeight() + 10;//nutedit
        }
        ...
        widgetAreaBounds.set(bgLeftWidth, bgBottomHeight, areaWidth, areaHeight); //nutedit__
        ...
        if (scrollY) {
            if (vScrollKnob != null) {
                ...
                vScrollBounds.set(boundsX-20, boundsY+12, vScrollWidth, areaHeight-20); //nutedit
                ...
                if (vScrollOnRight) {
                    vKnobBounds.x = width - bgRightWidth - vScrollKnob.getMinWidth() - 23; //nutedit
                } else {
